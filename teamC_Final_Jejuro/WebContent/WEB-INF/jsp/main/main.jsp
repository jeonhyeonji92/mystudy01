...
<!-- section3 : 숙박시설 등록 문구 시작 -->
<section class="section2">
    <div class="container">
      <div class="message text-center">
        <h2 class="big-title">당신의 <span> 숙박시설을</span> 등록할 수 있습니다!</h2>
        <p class="small-title">믿을 수 있는 검증된 사이트인 '제주로올레' 에서 당신의 업체를 등록해서 홍보할 수 있습니다.!!!</p>
        <a class="button large" href="bandbregisterform">등록하기</a> <a class=" dmbutton large" href="register">관리자 회원가입</a>
      </div>
      <!-- end message -->
    </div>
    <!-- end container -->
  </section>
<!-- section3 : 숙박시설 등록 문구 끝 -->
