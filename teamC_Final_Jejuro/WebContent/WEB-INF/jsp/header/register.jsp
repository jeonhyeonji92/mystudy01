		...
		<div class="content col-lg-12 col-md-12 col-sm-12 clearfix"
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<ul class="check">
					...
					<li><a href="#">숙소관리자 필수 입력사항 : 아이디,비밀번호</a></li>
					<li><a href="#">숙소관리자는 별도의 관리자 동의가 필요합니다.</a></li>
					<li><a href="#">회원가입시 여행플랜 기능을 사용할 수 있습니다.</a></li>
					<li><a href="#">관리자 회원가입시 숙소를 등록할 수 있습니다.</a></li>
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<form id="register" method="post" name="registerform" onsubmit="return DosignUp();"
					...
					<div class="form-group">
						<input type="password" name="signUpUserPwdCfm" id="signUpUserPwdCfm" class="form-control"
							placeholder="비밀번호확인">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input multiple="multiple" type="file" id="userImg" name="userImg">
					</div>
					<div class="form-group">
